...
#define TLD7002_UART_INDEX      (UART_2)            // 串口号
#define TLD7002_UART_BAUD       (2000000)           // 波特率
#define TLD7002_UART_RX         (UART2_TX_P14_2)   // TLD7002驱动模块的RX与单片机的TX连接
#define TLD7002_UART_HLSIL      (UART2_RX_P14_3)   // TLD7002驱动模块的HSLI_L与单片机的RX引脚连接
